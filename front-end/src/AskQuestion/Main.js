    ...
    return(
        <div className="margin-top-small bordered-input container-width" style={{'padding': '10px 0px', 'marginBottom': '200px', 'position': 'relative'}}>
            <div className="container-width">
                ...
                <input style={{'height': '40px'}} className="bordered-input" name="title" value={title} onChange={(event)=>{setTitle(event.target.value)}} />
            </div>
            ...
            <div className="margin-top-smaller container-width">
                ...
                <textarea style={{'minHeight': '50px'}} className="bordered-input" name="text" value={text} onChange={(event)=>{setText(event.target.value)}} />
            </div>
            <div className="flex-layout" style={{'position': 'absolute', 'right': '10px', 'bottom': '-60px'}}>
                <Button style={{'margin': '10px'}} variant="outline-primary">Submit</Button>
                <Button style={{'margin': '10px'}} variant="outline-danger">Clear</Button>
            </div>
        </div>
    )
}
