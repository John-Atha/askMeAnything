...
__decorate([
    typeorm_1.OneToMany((type) => question_upvote_entity_1.QuestionUpvote, (upvote) => upvote.question),
    __metadata("design:type", Array)
], Question.prototype, "upvotes", void 0);
__decorate([
    typeorm_1.ManyToMany((type) => keyword_entity_1.Keyword, (keyword) => keyword.questions, {
        cascade: true,
    }),
    typeorm_1.JoinTable(),
    __metadata("design:type", Array)
